...
const generateAccessToken = (id) => {
  ...
  try {
    ...
    throw new CustomError(error.message||"Unexpected error occurred while generating access token",500)
  }
};
...
const generateRefreshToken = (id) => {
  ...
  try {
    ...
    throw new CustomError(error.message||"Unexpected error occurred while generating refresh token",500)
  }
};
